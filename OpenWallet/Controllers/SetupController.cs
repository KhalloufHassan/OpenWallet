    ...
    private void SeedCategories()
    {
        db.Categories.AddRange(
            ...
            Parent("Shopping", "bi-bag", "#8b5cf6",
                ...
                Sub("Kids, Toys",              "bi-balloon-heart",          "#8b5cf6"),
            ...
            Parent("Vehicle", "bi-car-front", "#64748b",
                ...
                Sub("Maintenance",       "bi-tools",        "#64748b"),
                Sub("Parking",           "bi-p-square",     "#64748b")),
            ...
            Parent("Life", "bi-heart-pulse", "#ec4899",
                ...
                Sub("Active sport, fitness", "bi-bicycle",        "#ec4899"),
                Sub("Barber, Salons",        "bi-scissors",       "#ec4899"),
                Sub("Guests",                "bi-people",         "#ec4899"),
                Sub("Laundry",               "bi-droplet-half",   "#ec4899"),
                Sub("Life Events",           "bi-calendar-heart", "#ec4899")),
            ...
            Parent("Income", "bi-cash-coin", "#22c55e",
                ...
                Sub("Bonuses", "bi-star-fill",   "#22c55e")),
            ...
            Parent("Financial Expenses", "bi-bank", "#ef4444",
                ...
                Sub("Lending",    "bi-arrow-up-right-circle", "#ef4444")),
